...
# finished_dehalbacter_genomes <- c("NC_018866.1", "NC_018867.1", "NZ_CP007033.1")
# # Dehaligenimonas
...
# 
# # QUICK VERSION
# catchment <- produce_genome_ggbio(genomes = finished_dehalbacter_genomes, 
...
dhc_dehalogenase <- generate_keyword_index(dhc, column_value = "name", keyword = "dehalogenase", rejection_words = c("anchor", "haloacid"))
# ADD A KEYWORD 
